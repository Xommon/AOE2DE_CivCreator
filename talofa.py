...
class MyApp(QtWidgets.QMainWindow):
    ...
    def load_mod(self):
        ...
        GRAPHICS_GENERAL = {'Greek': 47, 'Mesopotamian': 46, 'Austronesian': 29, 'Byzantines': 7, 'Central Asian': 33, 'Central European': 4, 'East Asian': 5, 'Eastern European': 23, 'Mediterranean': 14, 'Mesoamerican': 15, 'Middle Eastern': 9, 'South Asian': 20, 'Southeast Asian': 28, 'West African': 26, 'Western European': 1}
